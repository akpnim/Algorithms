...
def quick_sort_first_element(A):
    ...
    left_sorted_array,left_counter = quick_sort_first_element(left) #solving left by recursion
    right_sorted_array, right_counter = quick_sort_first_element(right) #solving right by recursion
...
a,b = quick_sort_first_element(question_array)
print (a[0],a[3212])
print (b)
